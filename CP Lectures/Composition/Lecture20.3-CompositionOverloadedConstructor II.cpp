...
Employee::Employee(char* empName, char* rank, int d1, int m1, int y1, int d2, int m2, int y2) : dob(d1,m1,y1), joiningDate(d2,m2,y2)
{
...
void main()
{
	Employee boss("Peter", "Boss", 24, 7, 1949, 12, 3, 1989);
