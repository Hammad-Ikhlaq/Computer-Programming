...
class B : protected A
{
	...
	//PrintInfoA() is PROTECTED in Child Class
...
void B::PrintInfoB()
{
	PrintInfoA();	//Public of Parent is Protected in Child. Accessible in Member Functions
	cout << "b = " << b << endl;
}
...
void SampleFriendFunction()
{
	...
	objB.PrintInfoA();		//Public of Parent is Protected in Child. Accessible in Friend Functions
...
void main()
{
	...
	//objB.PrintInfoA(); //Public of Parent is Protected in Child now. Not Accessible in Non Member Functions
